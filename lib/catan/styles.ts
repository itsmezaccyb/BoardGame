...
export const TILE_STYLES: Record<TileStyleId, TileStyle> = {
    ...
    halloween: {
        ...
        tileBorder: { stroke: '#C9C0A6', width: 8, blurStdDeviation: 3 },
        waterBorder: { stroke: '#2C3A2C', width: 1.2 },
        outlines: {
            board: [
                { stroke: '#9EAF86', width: 24, opacity: 0.28, blurStdDeviation: 10 },
                { stroke: '#DFD6BE', width: 6, opacity: 0.8 },
            ],
            island: [
                { stroke: '#9E121C', width: 26, opacity: 0.55, blurStdDeviation: 9 },
                { stroke: '#E8636B', width: 6, opacity: 0.9 },
            ],
        },
        port: {
