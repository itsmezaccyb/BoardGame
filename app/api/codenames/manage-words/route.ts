...
// GET /api/codenames/manage-words?listId=<filename> - Get all words for a word list
export async function GET(request: NextRequest) {
    try {
        ...
        console.log(`📖 [Manage Words API] Getting words for list: ${listId}`);
        ...
        console.log(`✅ [Manage Words API] Found ${words?.length || 0} words`);
...
// POST /api/codenames/manage-words - Add a word or words to a word list
...
// DELETE /api/codenames/manage-words?listId=<filename>&wordId=<id> - Remove a word from a word list
