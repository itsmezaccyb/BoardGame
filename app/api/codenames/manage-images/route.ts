...
// GET /api/codenames/manage-images?listId=<folder> - Get all images for an image list
export async function GET(request: NextRequest) {
    try {
        ...
        console.log(`🖼️ [Manage Images API] Getting images for list: ${listId}`);
        ...
        console.log(`✅ [Manage Images API] Found ${images?.length || 0} images`);
...
// DELETE /api/codenames/manage-images?listId=<folder>&imageId=<id> - Remove an image from an image list
